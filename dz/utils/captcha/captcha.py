...
class Captcha(object):
    ...
    def initialize(self, width=200, height=75, color=None, text=None, fonts=None):
        ...
        self._text = text if text else random.sample(string.ascii_uppercase + string.ascii_uppercase + '3456789', 4)   # 改动
    ...
    def captcha(self, path=None, fmt='JPEG'):
        ...
        name = "".join(random.sample(string.ascii_lowercase + string.ascii_uppercase + '3456789', 24))  # 改动
